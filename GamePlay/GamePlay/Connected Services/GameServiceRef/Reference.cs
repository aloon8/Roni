...
namespace GamePlay.GameServiceRef {
    ...
    public interface IGameService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGameService/updateStartGameDB", ReplyAction="http://tempuri.org/IGameService/updateStartGameDBResponse")]
        void updateStartGameDB(string user1, string user2);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGameService/updateStartGameDB", ReplyAction="http://tempuri.org/IGameService/updateStartGameDBResponse")]
        System.Threading.Tasks.Task updateStartGameDBAsync(string user1, string user2);
    }
    ...
    public partial class GameServiceClient : System.ServiceModel.DuplexClientBase<GamePlay.GameServiceRef.IGameService>, GamePlay.GameServiceRef.IGameService {
        ...
        public void updateStartGameDB(string user1, string user2) {
            base.Channel.updateStartGameDB(user1, user2);
        }
        
        public System.Threading.Tasks.Task updateStartGameDBAsync(string user1, string user2) {
            return base.Channel.updateStartGameDBAsync(user1, user2);
        }
    }
}
